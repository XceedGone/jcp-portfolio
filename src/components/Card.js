...
export const CardWithImage = ({ title, description, imgUrl }) => {
  return (
    <Col className="flex justify-center">
        <div
            className="max-w-sm bg-sky-100 border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img className="rounded-t-lg" src={Laravel} alt=""/>
            </a>
            <div className="p-5">
                <a href="#">
